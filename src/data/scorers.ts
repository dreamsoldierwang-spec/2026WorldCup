...
// 2026世界杯射手榜 - 实时更新
// Updated: 2026-06-28 (更新J/K/L组第三轮真实赛果)
export const scorers: Scorer[] = [
  ...
  { rank: 2, name: 'Julian Alvarez', nameZh: '阿尔瓦雷斯', teamId: 'arg', goals: 5, matches: 3, position: 'Forward' },
  ...
  { rank: 7, name: 'Harry Kane', nameZh: '凯恩', teamId: 'eng', goals: 4, matches: 3, position: 'Forward' },
  ...
  { rank: 14, name: 'Cristiano Ronaldo', nameZh: 'C罗', teamId: 'por', goals: 2, matches: 3, position: 'Forward' },
  { rank: 14, name: 'Mikel Oyarzabal', nameZh: '奥亚萨瓦尔', teamId: 'esp', goals: 2, matches: 3, position: 'Forward' },
  { rank: 14, name: 'Luis Diaz', nameZh: '路易斯·迪亚斯', teamId: 'col', goals: 2, matches: 3, position: 'Forward' },
  ...
  { rank: 19, name: 'Jude Bellingham', nameZh: '贝林厄姆', teamId: 'eng', goals: 3, matches: 3, position: 'Midfielder' },
  ...
  { rank: 31, name: 'Bukayo Saka', nameZh: '萨卡', teamId: 'eng', goals: 1, matches: 3, position: 'Forward' },
  ...
  { rank: 31, name: 'Rafael Leao', nameZh: '莱奥', teamId: 'por', goals: 1, matches: 3, position: 'Forward' },
  { rank: 31, name: 'Bruno Fernandes', nameZh: 'B费', teamId: 'por', goals: 1, matches: 3, position: 'Midfielder' },
  { rank: 31, name: 'Goncalo Ramos', nameZh: '贡萨洛·拉莫斯', teamId: 'por', goals: 1, matches: 3, position: 'Forward' },
  ...
  { rank: 31, name: 'Ante Budimir', nameZh: '布迪米尔', teamId: 'cro', goals: 1, matches: 3, position: 'Forward' },
  { rank: 31, name: 'Luka Modric', nameZh: '莫德里奇', teamId: 'cro', goals: 1, matches: 3, position: 'Midfielder' },
  { rank: 31, name: 'Kudus', nameZh: '库杜斯', teamId: 'gha', goals: 1, matches: 3, position: 'Midfielder' },
  { rank: 31, name: 'James Rodriguez', nameZh: 'J罗', teamId: 'col', goals: 1, matches: 3, position: 'Midfielder' },
  ...
  { rank: 31, name: 'Bennacer', nameZh: '本纳赛尔', teamId: 'alg', goals: 1, matches: 3, position: 'Midfielder' },
  { rank: 31, name: 'Bounedjah', nameZh: '布内贾', teamId: 'alg', goals: 1, matches: 3, position: 'Forward' },
  ...
  { rank: 35, name: 'Martin Sucic', nameZh: '苏契奇', teamId: 'cro', goals: 2, matches: 2, position: 'Midfielder' },
  { rank: 35, name: 'Nikola Vlasic', nameZh: '弗拉西奇', teamId: 'cro', goals: 2, matches: 2, position: 'Midfielder' },
  { rank: 35, name: 'Laccason', nameZh: '拉卡森', teamId: 'gha', goals: 2, matches: 2, position: 'Forward' },
  { rank: 35, name: 'Mbuku', nameZh: '姆布库', teamId: 'cod', goals: 2, matches: 2, position: 'Forward' },
  { rank: 35, name: 'Yannick Bolasie', nameZh: '博拉西', teamId: 'cod', goals: 2, matches: 2, position: 'Forward' },
  { rank: 35, name: 'Cedric Bakambu', nameZh: '巴坎布', teamId: 'cod', goals: 2, matches: 3, position: 'Forward' },
  { rank: 35, name: 'Eldor Shomurodov', nameZh: '肖穆罗多夫', teamId: 'uzb', goals: 1, matches: 3, position: 'Forward' },
  { rank: 35, name: 'Riyad Mahrez', nameZh: '马赫雷斯', teamId: 'alg', goals: 2, matches: 3, position: 'Forward' },
  { rank: 35, name: 'Said Benrahma', nameZh: '本拉赫马', teamId: 'alg', goals: 2, matches: 3, position: 'Forward' },
  { rank: 35, name: 'Youcef Atal', nameZh: '阿塔尔', teamId: 'alg', goals: 2, matches: 3, position: 'Defender' },
  { rank: 35, name: 'Michael Gregoritsch', nameZh: '格雷戈里奇', teamId: 'aut', goals: 2, matches: 2, position: 'Forward' },
  { rank: 35, name: 'Musa Al-Tamari', nameZh: '阿尔塔马里', teamId: 'jor', goals: 1, matches: 3, position: 'Forward' },
  { rank: 35, name: 'Lautaro Martinez', nameZh: '劳塔罗', teamId: 'arg', goals: 2, matches: 3, position: 'Forward' },
  { rank: 35, name: 'Paulo Dybala', nameZh: '迪巴拉', teamId: 'arg', goals: 1, matches: 3, position: 'Forward' },
];
